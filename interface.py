...
class interface:
    ...
    def show_interface3(self):
        ...
        select_graph.grid(column=0, row=4)
        select_graph.current(0)
        tkinter.Button(window, text="add new Value", command=add_new_val).grid(column=0, row=5)
        tkinter.Button(window, text="add new graph", command=add_new_group).grid(column=0, row=6)
        tkinter.Button(window, text="Show data list", command=show_list).grid(column=0, row=7)
        tkinter.Button(window, text="Show selected graph", command=show_graph_select).grid(column=0, row=8)
